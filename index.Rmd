...
class: animate zoomIn zoomOut center middle
background-color: var(--near-black)
...
![:scale 50%](images/halperin-2008.png)
...
### Attentional Fluency/Cognitive Proficiency
...
![:scale 50%](images/trampush_devsci.png)
...
The first way\br is to be kind.

The second way\br is to be kind.

The third way\br is to be kind."
