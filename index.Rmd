...
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: ["xaringan-themer.css", "default", "assets/css/fighton-fonts.css", "assets/css/fighton-theme.css"]
...
```{r drillz-data}
neurocog <- readr::read_csv(patient, "neurocog.csv")
```
