...
output:
  xaringan::moon_reader:
    ...
    css: ["default", "assets/css/fighton-fonts.css", "assets/css/fighton-theme.css", "assets/css/fighton-style.css"]
...
# for fonts
library(showtext)
font_add_google("Monoton", "Latin Modern Mono")
showtext_auto()
theme_set(theme_minimal(base_family = "Latin Modern Mono"))
```

```{r mono-accent, eval=F, include=F}
# theme/style
style_mono_accent(
...
name: snoop
class: middle, right
background-image: url(images/snoop.gif)
