...
![:scale 35%](images/distracted-dog.gif)
...
class: middle center animated slideInUp slideOutDown
background-color: var(--near-black)
...
.left-column[
#### Consistency in Speed of Information Processing
...
.right-column[
### RTSD as a biomarker of ADHD

![:scale 70%](images/halperin-2008.png)
]
...
class: middle
#### Complex Working Memory as a Biomarker of ADHD

.left[![:scale 50%](images/trampush_devsci.png)]

.right[![:scale 50%](images/trampush_devsci_fig1.png)]
...
Currently funded to conduct large-scale molecular genetic analysis of working memory in >25,000 people, >70,000 phenotypes, and >293,000,000 genetic variants

.left[![:scale 45%](images/wm.gif)]

.right[![:scale 45%](images/gwm_fig1.png)]
