...
.pull-left[
![:scale 80%](images/ajp_2013.png)
]

.pull-right[
![:scale 80%](images/ajp_2013_fig1.png)
]
...
.pull-left[![:scale 90%](images/trampush_devsci.png)]
...
Currently funded to conduct large-scale genome-wide association study (GWAS) of working memory in .blue[**>25,000 people**] & .blue[**>70,000 WM phenotypes**], & .blue[**>293,000,000 genetic variants**]
...
>...is an inappropriate response to a salient or nonsalient environmental or internal stimulus. 
> For example:
...
>
> Environmentally dependent behaviors occur often and cannot be easily redirected and/or environmental dependency makes task completion very difficult
...
>Examples: excessive irritability, sensitivity to criticism, overwhelming nervousness and worry, and unhappiness.
