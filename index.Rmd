...
author2:
  - "Ashraf Elmashat, M.D."
  - "Clinical Professor of Psychiatry and the Behavioral Sciences, Associate Medical Director of Keck Outpatient Psychiatry and Behavioral Health Services"
institute: 
...
.pull-right[![:scale 55%](https://octodex.github.com/images/dinotocat.png)]
...
.pull-left[
![:scale 80%](images/wigal_2003.png)
]

.pull-right[
![:scale 50%](images/wigal_2003_fig1.png)
]
...
![:scale 60%](images/swanson_halperin_ahrq.png)
...
```{r drilldown-plot, fig.cap='HighchartR Drilldown on Cognitive Scores', fig.width=12, fig.height=8, fig.retina=3, out.width = "100%"}
# Tooltip
...
```{r drilldown2-plot, fig.cap='HighchartR Drilldown on Behavioral Ratings', fig.width=12, fig.height=8, fig.retina=3, out.width = "100%"}
# Tooltip
x <- c("Name", "Score", "Percentile", "Range")
y <- c("{point.name}", "{point.y}", "{point.y2}", "{point.range}")
tt <- tooltip_table(x, y)
